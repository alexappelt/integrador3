    ...
    <div class="content-body" style="min-height: 1042px;">
        ...
        <div class="container-fluid">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">Filiais</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-responsive-md">
                                        ...
                                        <tr>
                                            ...
                                            <th><strong>Localização <i class="flaticon-381-location-4"></i> </strong></th>
                                            <th></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <tr>
                                            <td> <c:out value="${filial.descricao}"  /> </td>
                                            <td><c:out value="${filial.segmento}"  /></td>
                                            <td><c:out value="${filial.localizacao}"  /></td>
                                        </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
