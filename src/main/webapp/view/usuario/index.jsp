    ...
    <div class="content-body" style="min-height: 1042px;">
        ...
        <div class="container-fluid">
            ...
            <div class="form-group">
                ...
                <form name="cadUsuario" action="/usuario" method="post" >

                    <div class="form-group row">
                        <label class="col-sm-3 text-right" > Login </label>
                        <input class="col-sm-9 form-control" name="login" />
                    </div>


                    <div class="form-group row">
                        <label class="col-sm-3 text-right" > Senha </label>
                        <input class="col-sm-9 form-control" type="password" name="senha" />
                    </div>


                    <div class="form-group row">
                        <label class="col-sm-3 text-right" for="exampleFormControlSelect1">Perfil</label>
                        <select class=" col-sm-9 form-control" id="exampleFormControlSelect1" name="perfil">
                            <c:forEach var="filial" items="${filiais}">
                            <option> <c:out value="${filial.descricao}"  /></option>
                            </c:forEach>
                        </select>
                    </div>
