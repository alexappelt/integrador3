    ...
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="/cardapio"><i class="far fa-plus text-success"></i>Cadastro Cardapio</a></li>
                    <li><a href="/listarcardapio"><i class="fad fa-list-ul text-info"></i>Lista de Cardapios</a></li>
                </ul>
            </li>
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="/usuario"><i class="far fa-plus text-success"></i>Cadastro Usuario</a></li>
                    <li><a href="/listarusuario"><i class="fad fa-list-ul text-info"></i>Lista de Usuarios</a></li>
                </ul>
            </li>
